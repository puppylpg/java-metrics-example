 ...
 * 当调用对象方法时，在{@link example.proxy.DynamicProxy#invoke(Object, Method, Object[])}里直接用反射就可以了，获取到其返回值，
 * 因为它已经包含有{@link example.proxy.JavaCoder}的对象了，可以直接反射调用其方法；
 *
 * 当rpc通信时，在{@link example.proxy.DynamicProxy#invoke(Object, Method, Object[])}里必须得是通过通信，获取到方法的返回值，
 ...
 * 或者说{@link example.proxy.DynamicProxy#invoke(java.lang.Object, java.lang.reflect.Method, java.lang.Object[])}里。
 *
